    ...
    <View>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ fontSize: 20, color: Cores.cor5 }}>R$ 5.000.000</Text>
          </View>
          <View
            style={{
              width: 220,
          ...
          >
            <View>
              <Text style={{ color: Cores.cor5 }}>Premio 15 Acertos</Text>
            </View>
            <View>
              <Text style={{ fontSize: 16, color: Cores.cor5 }}>5.000.000</Text>
            </View>
          </View>
        </View>

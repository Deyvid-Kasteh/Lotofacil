...
const BottomTabNavigator = () => {
  return (
    ...
    >
      ...
      />
      <Tab.Screen name="Criar Jogo" component={CriarJogoScreen}         options={{ headerShown: true, headerTitleAlign: "center" }}
/>
      <Tab.Screen name="Meus Jogos" component={MeusJogosScreen}         options={{ headerShown: true, headerTitleAlign: "center" }}
/>
      <Tab.Screen name="Conferir" component={ConferirScreen}         options={{ headerShown: true, headerTitleAlign: "center" }}
/>
    </Tab.Navigator>
  );
};

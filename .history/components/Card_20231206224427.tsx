...
const Card = () => {
    ...
    const [alturaCar, setAlturaCar] = useState<number>(200);

    const toggleAltura = (): void => {
      const novaAltura: number = alturaCar === 200 ? 50 : 200;
      setAlturaCar(novaAltura);
    };
  return (
    <View
      style={[
    ...
    >
      ...
      >
        <Text
          style={{
            fontSize: 20,
            color: alturaCar === 50 ? Cores.cor4 : Cores.cor5,
          }}
        >
          Último Sorteio
        </Text>

    ...
    <View>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ fontSize: 20, color: Cores.cor1 }}>Premio</Text>
          </View>
          <View
            style={{
              width: 200,
          ...
          >
            <Text style={{ fontSize: 24, color: Cores.cor5 }}>
              R$ 5.000.000
            </Text>
          </View>
          <View
        ...
        >
          ...
          >
            <Text style={{ fontSize: 20, color: Cores.cor1 }}>+ Acertos</Text>
          </View>
          <View
            style={{
              width: 200,
          ...
          >
            <Text style={{ fontSize: 18, color: Cores.cor5 }}>14:</Text>
            <Text style={{ fontSize: 18, color: Cores.cor5 }}>433</Text>
            <Text style={{ fontSize: 18, color: Cores.cor5 }}>valor:</Text>
            <Text style={{ fontSize: 18, color: Cores.cor5 }}>R$1.732,84</Text>
          </View>

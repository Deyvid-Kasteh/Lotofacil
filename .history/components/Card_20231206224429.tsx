...
const Card = () => {
    ...
    const [alturaCard, setAlturaCard] = useState<number>(200);

    const toggleAltura = (): void => {
      const novaAltura: number = alturaCard === 200 ? 50 : 200;
      setAlturaCard(novaAltura);
    };
  return (
    <View
      style={[
    ...
    >
      ...
      >
        <Text
          style={{
            fontSize: 20,
            color: alturaCard === 50 ? Cores.cor4 : Cores.cor5,
          }}
        >
          Último Sorteio
        </Text>

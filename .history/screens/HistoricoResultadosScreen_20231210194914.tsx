...
const HistoricoResultadosScreen = () => {
  ...
  // Exemplo de uso:
let resultado: number | null | string = null;  console.log(resultado);

  const BuscarPeriodo = () => {
    let periodoValue: number | null | string = value;
    resultado = obterSubArray(periodoValue: number | null | string);
  };
